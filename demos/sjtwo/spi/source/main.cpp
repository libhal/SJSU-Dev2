...
int main()
{
  ...
  sjsu::LogInfo("Manufacturer ID: 0x%.2x", data[0]);
  sjsu::LogInfo("Device ID: 0x%.2x", data[1]);
  sjsu::LogInfo("Program halting...");
  sjsu::Halt();
  return 0;
}
