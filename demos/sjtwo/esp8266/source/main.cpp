...
constexpr char kGetRequestPostMan[] =
...
int main()
{
  ...
  for (int i = 0; i < 2; i++)
  {
    ...
    //     sjsu::InternetSocket::Protocol::kTCP, "postman-echo.com"sv, 80, 5s));
    LOG_IF_NOT_SUCCESSFUL(wifi.Connect(
        sjsu::InternetSocket::Protocol::kTCP, "www.example.com"sv, 80, 5s));
