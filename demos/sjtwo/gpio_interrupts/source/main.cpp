...
int main()
{
  ...
  pin0_15.GetPin().SetMode(sjsu::Pin::Mode::kPullUp);
  ...
  pin2_9.GetPin().SetMode(sjsu::Pin::Mode::kPullUp);
  ...
  pin0_30.GetPin().SetMode(sjsu::Pin::Mode::kPullUp);
  ...
  pin0_29.GetPin().SetMode(sjsu::Pin::Mode::kPullUp);
