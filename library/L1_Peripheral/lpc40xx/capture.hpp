...
{
 public:
    template<const Timer::ChannelPartial_t &port>
    ...
    struct Channel // NOLINT
    {
     private:
        ...
        inline static const Timer::ChannelPartial_t kTimerPartial0 = {
        ...
        inline static const Timer::ChannelPartial_t kTimerPartial1 = {
        ...
        inline static const Timer::ChannelPartial_t kTimerPartial2 = {
        ...
        inline static const Timer::ChannelPartial_t kTimerPartial3 = {
     ...
     public:
        inline static const Timer::Channel_t kCaptureTimer0 =
        {
            .channel = kTimerPartial0,
            .isr = TimerHandler<kTimerPartial0>
        };
        inline static const Timer::Channel_t kCaptureTimer1 =
        {
            .channel = kTimerPartial1,
            .isr = TimerHandler<kTimerPartial1>
        };
        inline static const Timer::Channel_t kCaptureTimer2 =
        {
            .channel = kTimerPartial2,
            .isr = TimerHandler<kTimerPartial2>
        };
        inline static const Timer::Channel_t kCaptureTimer3 =
        {
    ...
    static void TimerHandler(const Timer::ChannelPartial_t & channel)
    {
    ...
    Status Initialize(
        ...
        IsrPointer isr = nullptr, int32_t priority = -1) const override
    {
        ...
        uint32_t prescaler =
            system_controller_
                .GetPeripheralFrequency(timer_.channel.power_id) / frequency;
    ...
    void ConfigureCapture(
            CaptureChannelNumber channel,
            CaptureEdgeMode mode) const override
    {
    ...
    void EnableCaptureInterrupt(
            CaptureChannelNumber channel, bool enabled) const override
    {
        uint32_t shift = (channel == kCaptureChannel1) ? 3 : 0;
        ...
        {
            timer_.channel.timer_register->CCR |= (0x04 << shift);
            timer_.channel.timer_register->IR |=
                (channel == kCaptureChannel1) ? 0x20 : 0x10;
        }
    }
 private:
    const Timer::Channel_t &timer_;
