SYSTEM_INCLUDES += $(LIBRARY_DIR)/platforms/targets/linux/freertos_posix/

LIBRARY_LINUX += $(LIBRARY_DIR)/platforms/targets/linux/startup.cpp
LIBRARY_LINUX += $(LIBRARY_DIR)/platforms/targets/linux/freertos_posix/port.c
