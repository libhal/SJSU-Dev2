...
LIBRARY_STM32F10X += $(LIBRARY_DIR)/L0_Platform/stm32f4xx/diskio.cpp
LIBRARY_STM32F10X += $(LIBRARY_DIR)/L0_Platform/stm32f4xx/startup.cpp
LIBRARY_STM32F10X += $(LIBRARY_DIR)/L0_Platform/arm_cortex/m4/ARM_CM4F/port.c
...
$(eval $(call BUILD_LIRBARY,libstm32f4xx,LIBRARY_STM32F10X))
