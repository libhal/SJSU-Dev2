...
namespace sjsu
{
	class lcd 
	{
		public:
			...
			static constexpr CursorPosition_t kDefaultCursorPosition = CursorPosition_t{ 0, 0 };
		...
		lcd(BusMode bus_mode, DisplayMode display_mode, FontStyle font_style)
			{
			kBusMode = bus_mode;
		  ...
		  [[gnu::always_inline]] void ResetCursorPosition()
		  {
