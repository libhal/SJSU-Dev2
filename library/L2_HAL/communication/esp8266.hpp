...
#include "L2_HAL/communication/internet_socket.cpp"
...
class Esp8266 : public InternetSocket, public WiFi
{
 public:
  ...
  constexpr Esp8266(const Uart & port, uint32_t baud_rate = kDefaultBaudRate)
              ...
              std::chrono::nanoseconds timeout) override
  {
    ...
    do
    {
      ...
      size_t bytes_to_read  = std::min(size - position, received_bytes);
