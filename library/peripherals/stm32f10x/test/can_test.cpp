...
{
TEST_CASE("Testing stm32f10x Can")
{
  // Simulate local version of LPC_CAN
  CAN_TypeDef local_can;
  ...
  constexpr units::frequency::hertz_t kDummySystemControllerClockFrequency = 12_MHz;
  ...
  sjsu::InterruptController::SetPlatformController(&mock_interrupt_controller.get());
