...
class Can final : public sjsu::Can
{
 public:
  ...
  struct MasterStatus  // NOLINT
  {
    ...
    /// mode
    static constexpr bit::Mask kInitializationAcknowledge =
        bit::MaskFromRange(0);
    ...
    static constexpr bit::Mask kSleepAcknowledgeInterrupt =
        bit::MaskFromRange(4);
  ...
  {
    static constexpr bit::Mask kRequestCompletedMailbox0 =
        bit::MaskFromRange(0);
    ...
    static constexpr bit::Mask kTransmissionErrorMailbox0 =
        bit::MaskFromRange(3);
    static constexpr bit::Mask kAbortRequestMailbox0 = bit::MaskFromRange(7);
    static constexpr bit::Mask kRequestCompletedMailbox1 =
        bit::MaskFromRange(8);
    static constexpr bit::Mask kTransmissionOkMailbox1 = bit::MaskFromRange(9);
    static constexpr bit::Mask kArbitrationLostMailbox1 =
        bit::MaskFromRange(10);
    static constexpr bit::Mask kTransmissionErrorMailbox1 =
        bit::MaskFromRange(11);
    static constexpr bit::Mask kAbortRequestMailbox1 = bit::MaskFromRange(15);
    static constexpr bit::Mask kRequestCompletedMailbox2 =
        bit::MaskFromRange(16);
    static constexpr bit::Mask kTransmissionOkMailbox2 = bit::MaskFromRange(17);
    static constexpr bit::Mask kArbitrationLostMailbox2 =
        bit::MaskFromRange(18);
    static constexpr bit::Mask kTransmissionErrorMailbox2 =
        bit::MaskFromRange(19);
    ...
    static constexpr bit::Mask kLowestPriorityFlagMailbox0 =
        bit::MaskFromRange(29);
    static constexpr bit::Mask kLowestPriorityFlagMailbox1 =
        bit::MaskFromRange(30);
    static constexpr bit::Mask kLowestPriorityFlagMailbox2 =
        bit::MaskFromRange(31);
  };
  ...
  struct MasterControl  // NOLINT
  {
    ...
    static constexpr bit::Mask kNoAutomaticRetransmission =
        bit::MaskFromRange(4);
    static constexpr bit::Mask kAutomaticWakeupMode = bit::MaskFromRange(5);
    static constexpr bit::Mask kAutomaticBussOffManagement =
        bit::MaskFromRange(6);
    static constexpr bit::Mask kTimeTriggeredCommunicationMode =
        bit::MaskFromRange(7);
 ...
 private:
  ...
  {
    channel_.can->FMR = bit::Insert(
        channel_.can->FMR, Value(mode), FilterMaster::kInitializationMode);
  }

  void SetFilterType(bit::Mask filter, FilterType mode)
  {
    channel_.can->FM1R = bit::Insert(channel_.can->FM1R, Value(mode), filter);
  }

  void SetFilterScale(bit::Mask filter, FilterScale scale)
  {
    channel_.can->FS1R = bit::Insert(channel_.can->FS1R, Value(scale), filter);
  }

  void SetFilterFIFOAssignment(bit::Mask filter, FIFOAssignment fifo)
  {
    channel_.can->FFA1R = bit::Insert(channel_.can->FFA1R, Value(fifo), filter);
  }

  void SetFilterActivationState(bit::Mask filter, FilterActivation state)
  {
    channel_.can->FA1R = bit::Insert(channel_.can->FA1R, Value(state), filter);
  }
