...
template <int port, size_t length = 1024>
inline Uart<length> & GetUart()
{
  if constexpr (port == 0)
  {
    ...
    static const lpc40xx::UartBase::Port_t kUart0 = {
    ...
    static Uart<length> uart(kUart0);
    return uart;
  }
  else if constexpr (port == 2)
  {
    ...
    static const lpc40xx::UartBase::Port_t kUart2 = {
    ...
    static Uart<length> uart(kUart2);
    return uart;
  }
  else if constexpr (port == 3)
  {
    ...
    static const lpc40xx::UartBase::Port_t kUart3 = {
    ...
    static Uart<length> uart(kUart3);
    return uart;
  }
  else
  {
