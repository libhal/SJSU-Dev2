...
class Ssp : public SspInterface
{
 public:
    ...
    static constexpr uint8_t kPin18 = 18;
    static constexpr uint8_t kPin17 = 17;
    static constexpr uint8_t kPin15 = 15;
    static constexpr uint8_t kPin9 = 9;
    static constexpr uint8_t kPin8 = 8;
    static constexpr uint8_t kPin7 = 7;
    static constexpr uint8_t kDataBit = 0;
    static constexpr uint8_t kFrameBit = 4;
    static constexpr uint8_t kPolarityBit = 6;
    static constexpr uint8_t kPhaseBit = 7;
    static constexpr uint8_t kDividerBit = 8;
    static constexpr uint8_t kMasterModeBit = 2;
    static constexpr uint8_t kDataLineIdleBit = 4;
    ...
    constexpr Ssp() : mosi_(mosi_pin_),
        ...
        mosi_pin_(kPort0, kPin18),   // P0.18
        miso_pin_(kPort0, kPin17),   // P0.17
        sck_pin_(kPort0, kPin15),    // P0.15
    ...
    bool Initialize() override
    {
        ...
        else
        {
            ...
            ssp_registers[static_cast<uint32_t>(pssp_)]->CR0 |=
                (clock_divider_ << kDividerBit);
            // enable SSP
            ssp_registers[static_cast<uint32_t>(pssp_)]->CR1 &= ~(1 << 1);
            ssp_registers[static_cast<uint32_t>(pssp_)]->CR1 |= (1 << 1);
            ssp_registers[static_cast<uint32_t>(pssp_)]->CR1 &=
                ~(1 << kMasterModeBit);
            ssp_registers[static_cast<uint32_t>(pssp_)]->CR1 |=
                (master_mode_ << kMasterModeBit);
