...
constexpr uint8_t kI2c0 = static_cast<uint8_t>(I2c::Port::kI2c0);
constexpr uint8_t kI2c1 = static_cast<uint8_t>(I2c::Port::kI2c1);
constexpr uint8_t kI2c2 = static_cast<uint8_t>(I2c::Port::kI2c2);
