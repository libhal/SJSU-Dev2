...
class CommandInterface
{
 public:
  ...
  virtual int AutoComplete([[maybe_unused]] int argc,
                           [[maybe_unused]] const char * const argv[],
                           [[maybe_unused]] const char * completion_array[],
                           [[maybe_unused]] const size_t kCompletionArrayLength)
  {
    return 0;
  }
};
...
///
/// @param kNumberOfCommands is the number of commands you would like your
